...
export default function ContactSection() {
  ...
  return (
    <section ref={sectionRef} className="relative z-[60] grid min-h-screen grid-rows-[1fr_auto]">
      <div className="grid grid-cols-1 gap-6 px-[4vw] pt-[10vh] pb-[72px] md:grid-cols-2 md:grid-rows-[1fr] md:gap-0 md:pt-[22vh] md:pr-[6vw] md:pb-[12vh] md:pl-[8vw]">
        ...
        <div ref={cardRef} className="glass-card p-4 md:w-[min(460px,38vw)] md:self-end md:justify-self-end md:p-8">
          ...
          <div className="mb-6 space-y-4">
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <a href="mailto:jer.schaeffer@gmail.com" aria-label="send mailto" className="link-hover text-sm">
